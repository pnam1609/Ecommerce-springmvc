                    ...
                    <tbody>
						<c:forEach items="${list}" var="dm">                   
	                      <tr>
	                        <td>${dm.maDM}</td>
	                        <td>${dm.tenDM}</td>
	                        <td><a href="SuaDanhMuc/${dm.maDM}"><i class="far fa-edit"></i> &nbsp; Sửa</a></td>
	                        <td><a href="xoaDanhMuc/${dm.maDM}"><i class="far fa-trash-alt"></i> &nbsp; Xóa</a></td>
	                      </tr>
                      	</c:forEach>
                    </tbody>
                  </table>
              <div class="row">
              		<a href="ThemDanhMuc"><button type="submit" class="btn btn-outline-warning">Thêm mới danh mục</button></a>             		
              </div>    
